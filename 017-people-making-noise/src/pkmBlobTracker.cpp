...
float pkmBlobTracker::getOrientation(ofCvTrackedBlob &blob)
{
	...
	char *status = new char[numPts];
	float *err = new float[numPts];
	CvPoint2D32f *featuresA = new CvPoint2D32f[numPts];
	CvPoint2D32f *featuresB = new CvPoint2D32f[numPts];
	...
	cvCalcOpticalFlowPyrLK(cvPrevGrayImage,cvGrayImage,
						   NULL, NULL,
